 ...
 */
export function GoogleMap(API_KEY, API_VERSION, LANGUAGE) {
  ...
  /**
	 ...
	 */
  self.getMarkers = function (callback) {
    addWorker(function () {
  ...
  /**
	 ...
	 */
  self.setEndLocation = function (Latitude, Longitude) {
  ...
  self.watchStartPosition = function () {
    addWorker(function () {
      if (startMarker != null) {
  ...
  /**
	 ...
	 */
  self.setStartGps = function (resolve, reject, options) {
    addWorker(function () {
  ...
  /**
	 ...
	 * @param {number} Longitude
	 */
  self.setStartLocation = function (Latitude, Longitude) {
    addWorker(function () {
  ...
  /**
	 ...
	 * @param {string} text 
	 */
  self.setStartText = function (text) {
    endText = text;
    return this;
  };
  /**
  ...
  /**
	 * Center on location
	 */
  self.centerOn = function (location) {
    addWorker(function () {
      if (!empty(location))
  ...
  /**
	 ...
	 */
  self.setEndAddress = function (address, callback) {
    addWorker(function () {
  ...
  /**
	 ...
	 */
  self.showEndMarker = function (imageURI) {
  ...
  /**
	 ...
	 * @param {string} [imageURI] - image to display
	 */
  self.showStartMarker = function (imageURI) {
    directionsRendererOptions.suppressMarkers = true;
    addWorker(function () {
  ...
  self.drawCircleAtStart = function (rad) {
    addWorker(function () {
  ...
  self.onCenterChanged = function () { };
  self.onZoomChanged = function () { };
  ...
  /**
	 ...
	 */
  self.setMarker = function (lat, lng, imageURI, onClick, label) {
    addWorker(function () {
      var marker = new google.maps.Marker({
  ...
  self.setDirectionsOptions = function (options) {
  ...
  /**
	 ...
	 */
  self.generateRoute = function (opts, noLoader) {
  ...
  self.showMapSettings = function (callback) {
  ...
  /**
	 ...
	 */
  self.setDirections = function (elem) {
  ...
  self.getCenter = function (callback) {
    addWorker(function () {
  ...
  self.onWorkersFinished = function () {
  ...
  /**
	 ...
	 */
  function addWorker(callback, addFirst = false) {
    if (addFirst)
