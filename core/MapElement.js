 ...
 */
export var MapElement = function(API_KEY,API_VERSION,LANGUAGE){
  /**@type {MapElement} */
  var self = this;
  ...
  /**
	 ...
	 * @param {number} lng 
	 * @param {string} imageURI 
	 * @param {function(google.maps.Marker):any} [onClick]
  ...
  /**
	 * @param {DirectionSettings} options  
	 */
