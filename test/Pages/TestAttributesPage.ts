      ...
      <div class="" style="padding: 2.0rem;">
        ...
        <div style="margin-bottom: 2.0rem;">
          ...
          <div [attribute]="this.dynamicAttributes" 
               style="margin-top: 1.0rem; padding: 1.5rem; background: lightgray; border: 2px solid #333;">
        ...
        <div style="margin-bottom: 2.0rem;">
          ...
          <div style="margin-bottom: 1.0rem;">
            ...
            <span style="margin-left: 1.0rem;">Current: {{ this.fontSize }}px</span>
          </div>
          ...
          <div style="margin-top: 1.0rem; padding: 1.0rem; background: #f9f9f9;">
            <strong>Current Style Object:</strong>
            <pre style="margin: 5px 0; font-size: 1.2rem;">{{ JSON.stringify(this.dynamicStyles, null, 2) }}</pre>
          </div>
        </div>
        ...
        <style>
          .highlight { background-color: yellow; padding: 1.0rem; }
          .success { background-color: lightgreen; padding: 1.0rem; color: darkgreen; font-weight: bold; }
          .error { background-color: lightcoral; padding: 1.0rem; color: darkred; font-weight: bold; }
          .warning { background-color: lightyellow; padding: 1.0rem; color: darkorange; border-left: 4px solid orange; }
          .info { background-color: lightblue; padding: 1.0rem; color: darkblue; border-left: 4px solid blue; }
        </style>
        ...
        <div style="margin-bottom: 2.0rem;">
          ...
          <div [class]="this.dynamicClass" style="margin-top: 1.0rem; min-height: 5.0rem;">
        ...
        <div style="margin-bottom: 2.0rem;">
          ...
          <select onchange="this.selectedOption = event.target.value" style="width: 100%; padding: 8px; font-size: 1.4rem;">
