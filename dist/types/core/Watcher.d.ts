...
export declare const Watcher: {
     ...
     */
    on<T extends object>(object: T, onPropertyChangeCallback?: PropertyChangeCallback, onObjectChangeCallback?: ObjectChangeCallback, ignoreProperties?: string[]): T;
    off: (object: WatchedObject, handler?: PropertyChangeCallback | ObjectChangeCallback) => void;
};
/**
